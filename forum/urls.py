...
urlpatterns = [
    ...
    path('api/v2/threads/<str:thread_id>/pin', PinThreadAPIView.as_view(), name="pin-thread"),
    path('api/v2/threads/<str:thread_id>/unpin', UnpinThreadAPIView.as_view(), name="unpin-thread"),
]

...
os.environ['DJANGO_SETTINGS_MODULE'] = 'forum.settings.test'
django_setup()
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/forum",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'openedx forum app',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'forum'),
                os.path.join(root_path, 'forum/migrations')])
